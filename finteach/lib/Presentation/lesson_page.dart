  ...
  child: Center(
    child: ElevatedButton(
      style: ElevatedButton.styleFrom(
        primary: selectedOptionIndex != -1 ? Colors.green : Colors.grey, // Button color changes based on selection
      ...
      onPressed: selectedOptionIndex != -1 // Button is only enabled if an option is selected
          ? () {
              if (!_hasPressedCheck) {
                setState(() {
                ...
                setState(() {
                  if (currentQuestionIndex < questions.length - 1) {
                    ...
                    _showCompletionDialog(); // Call the function to show completion dialog
          ...
          Align(
            ...
            child: ConfettiWidget(
              ...
              blastDirectionality: BlastDirectionality
                  .explosive,
                  numberOfParticles: 40, // don't specify a direction, blast randomly
              shouldLoop:
